...
There is no other code path by which committed blocks disappear.
*Check:* CT-1 model (any unexplained disappearance fails); CT-2 (crash must not eat
committed blocks — ties INV-40).
